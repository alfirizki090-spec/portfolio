...
const skills = ["API Integration", "Version Control Git", "Web Performance Optimization", "State Management", "Server-Side Rendering (SSR)", "Static Site Generation (SSG)", "Component-Driven Development", "Responsive Web Design"];
...
export default function Expertise() {
  return (
    <section className="lg:pt-18" id="ts">
      <h3 className="font-bold text-slate-200 bg-slate-900/80 backdrop-blur-sm py-6 px-6 mt-15 sticky top-0 z-10 lg:hidden">
        EXPERTISE
      </h3>
      <h4 className="font-bold bg-linear-to-r from-pink-400 to-blue-500 bg-clip-text w-fit text-transparent text-lg py-6 px-6">Skills</h4>
      <div className="mb-10">
      ...
      <h4 className="font-bold bg-linear-to-r from-pink-400 to-blue-500 bg-clip-text w-fit text-transparent text-lg py-6 px-6">Tech Stacks</h4>
      <div>
